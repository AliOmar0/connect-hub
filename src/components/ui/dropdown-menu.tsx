...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      // Menu-item states (Requirements 10.1, 1.2): highlight/focus use the
      // accent token, active adds a subtle press, disabled dims. Transition uses
      // the `duration-fast` motion token.
